...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-full space-y-6 p-6 lg:p-8">
      ...
      */}
      <div className="overflow-hidden rounded-[32px] border border-slate-200/70 bg-[radial-gradient(circle_at_top_left,rgba(37,99,235,0.14),transparent_28%),radial-gradient(circle_at_top_right,rgba(13,148,136,0.10),transparent_24%),linear-gradient(135deg,#ffffff,#f8fafc)] p-6 shadow-[0_18px_60px_rgba(15,23,42,0.08)] sm:p-7">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Live operational view across properties, leases, occupancy, and trends.
            </p>
          </div>

          {/* <span className="inline-flex self-start rounded-full border border-white/70 bg-white/90 px-4 py-2 text-xs font-medium text-slate-600 shadow-sm sm:self-auto">
            Dashboard snapshot
          </span> */}
        </div>
      </div>
